...
export default {
  ...
  ChartDiputadosProvincia: defineAsyncComponent(
    () => import('./ChartDiputadosProvincia.vue'),
  ),
  ChartDiputadosProvinciaBloque: defineAsyncComponent(
    () => import('./ChartDiputadosProvinciaBloque.vue'),
  ),
  ChartSenadoresPartido: defineAsyncComponent(
    () => import('./ChartSenadoresPartido.vue'),
  ),
  ChartSenadoresProvincia: defineAsyncComponent(
    () => import('./ChartSenadoresProvincia.vue'),
  ),
  ChartSenadoresProvinciaPartido: defineAsyncComponent(
  ...
  ChartFeriadosCalendario: defineAsyncComponent(
    () => import('./ChartFeriadosCalendario.vue'),
  ),
  ChartSenadoActasVotos: defineAsyncComponent(
    () => import('./ChartSenadoActasVotos.vue'),
  ),
  ChartSenadoActasResultado: defineAsyncComponent(
    () => import('./ChartSenadoActasResultado.vue'),
  ),
  ChartSenadoActasArbol: defineAsyncComponent(
    () => import('./ChartSenadoActasArbol.vue'),
  ),
  ChartSenadoActasPresentismo: defineAsyncComponent(
    () => import('./ChartSenadoActasPresentismo.vue'),
  ),
  ChartDiputadosActasVotos: defineAsyncComponent(
    () => import('./ChartDiputadosActasVotos.vue'),
  ),
  ChartDiputadosActasResultado: defineAsyncComponent(
    () => import('./ChartDiputadosActasResultado.vue'),
  ),
  ChartDiputadosActasArbol: defineAsyncComponent(
    () => import('./ChartDiputadosActasArbol.vue'),
  ),
  ChartDiputadosActasPresentismo: defineAsyncComponent(
    () => import('./ChartDiputadosActasPresentismo.vue'),
  ),
  ChartPresidentes: defineAsyncComponent(
    () => import('./ChartPresidentes.vue'),
  ),
  ChartRems: defineAsyncComponent(() => import('./ChartRems.vue')),
  ChartRemIpc: defineAsyncComponent(() => import('./ChartRemIpc.vue')),
  ChartRemDashboard: defineAsyncComponent(
    () => import('./ChartRemDashboard.vue'),
  ),
  ChartRemInflacionExpectativas: defineAsyncComponent(
    () => import('./ChartRemInflacionExpectativas.vue'),
  ),
