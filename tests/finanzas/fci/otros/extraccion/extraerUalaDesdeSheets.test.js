...
import { extraerUalaCuentaRemuneradaDesdeSheets } from '@/finanzas/fci/otros/extraccion/extraerUalaDesdeSheets.js'

describe('extraerUalaDesdeSheets', () => {
  it(
    'extrae Uala Cuenta Remunerada desde Google Sheets correctamente',
    async () => {
