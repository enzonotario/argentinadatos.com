...
import { migration_002_senador_periodo_unique } from './002_senador_periodo_unique.ts'

const MIGRATIONS = [
  migration_001_initial_schema,
  migration_002_senador_periodo_unique,
]
...
export class MigrationRunner {
  ...
  constructor(db: any, scope = 'senado-senadores') {
    this.db = db
    this.scope = scope
  }
