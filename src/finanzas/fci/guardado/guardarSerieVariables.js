import { FciVariablesDatabaseService } from '../databaseVariables/service.js'
...
export async function guardarSerieVariables(
  items,
...
async function generarEndpointsEstaticos(db) {
  ...
  for (const nombre of nombres) {
    ...
    escribirRuta(
      `/finanzas/fci/variables/${nombreNormalizado}`,
      historialResultado,
    )
  }
}
